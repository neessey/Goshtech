                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start gap-4 p-4 neon-border rounded-xl">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-400">
                                            Institut Universitaire d&apos;Abidjan<br />
                                            Campus Corniche<br />
                                ...
                                <div className="flex items-start gap-4 p-4 neon-border rounded-xl">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-400">+225  05 56 13 02 45</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-8 h-64 rounded-xl overflow-hidden neon-border">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15889.967498053833!2d-4.025384567907304!3d5.3416214141909055!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfc1eba40c59f839%3A0xeb29864117bdeb99!2sIUA%20campus%20Corniche!5e0!3m2!1sfr!2sci!4v1774804867915!5m2!1sfr!2sci"
                                    width="100%"
                                    height="100%"
